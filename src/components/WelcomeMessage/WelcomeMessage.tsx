...
// src/components/WelcomeMessage/WelcomeMessage.tsx
'use client'
...
const WelcomeMessage = ({ googleUser, onEditProfile }: WelcomeMessageProps) => {
  ...
  return (
    <div className='user-profile-summary'>
      ...
      <div className='profile-summary-content'>
        <h3>Welcome, {profile.name || googleUser?.name}!</h3>
        <p>Based on your profile:</p>
        <ul>
          ...
          <li>Goals: {profile.goals.join(', ')}</li>
        </ul>
        <button
